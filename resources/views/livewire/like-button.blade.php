<button wire:click="toggleLike" class="group flex items-center gap-1.5 px-3 py-2 rounded-lg transition-colors {{ $isLiked ? 'text-rose-500 bg-rose-50' : 'text-zinc-500 hover:text-rose-500 hover:bg-rose-50' }}">
    @if($isLiked)
